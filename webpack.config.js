...
module.exports = {
    ...
    optimization: {
        ...
        moduleIds: 'deterministic', // For consistent module IDs
        chunkIds: 'deterministic', // For consistent chunk IDs
        mangleExports: 'deterministic', // For consistent export names
        usedExports: true, // Enable tree-shaking by detecting used exports
