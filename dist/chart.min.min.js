...
!function (t, e) {
  ...
  function n(t) {
    var i = t[0],
      n = t[1],
      a = t[2];
    return [e(t)[0], 1 / 255 * Math.min(i, Math.min(n, a)) * 100, 100 * (a = 1 - 1 / 255 * Math.max(i, Math.max(n, a)))];
  }
  function a(t) {
    var e,
      i = t[0] / 255,
  ...
  var I = S,
    ...
    F = {
      ...
      getAlpha: function (t) {
        var e = R(t);
        return e || (e = L(t)) || (e = W(t)) ? e[3] : void 0;
      },
      ...
      rgbString: function (t, e) {
        return e < 1 || t[3] && t[3] < 1 ? Y(t, e) : "rgb(" + t[0] + ", " + t[1] + ", " + t[2] + ")";
      },
      rgbaString: Y,
      ...
      hslString: function (t, e) {
        return e < 1 || t[3] && t[3] < 1 ? z(t, e) : "hsl(" + t[0] + ", " + t[1] + "%, " + t[2] + "%)";
      },
      hslaString: z,
  ...
  var Wt = gt.extend({
      ...
      inRange: function (t, e) {
        return Lt(this._view, t, e);
      },
      inLabelRange: function (t, e) {
        var i = this._view;
        return At(i) ? Lt(i, t, null) : Lt(i, null, e);
      },
      inXRange: function (t) {
        return Lt(this._view, t, null);
      },
      inYRange: function (t) {
        return Lt(this._view, null, t);
      },
      getCenterPoint: function () {
        var t,
          e,
    ...
    Vt = Ot,
    Ht = Wt;
  Yt.Arc = Nt, Yt.Line = zt, Yt.Point = Vt, Yt.Rectangle = Ht;
  var Et = ut.options.resolve;
  ot._set("bar", {
    hover: {
      mode: "label"
    },
  ...
  var Bt = kt.extend({
      ...
      _resolveElementOptions: function (t, e) {
        ...
        for (i = 0, n = h.length; i < n; ++i) u[a = h[i]] = Et([s[a], o[a], l[a]], d, e);
        return u;
      }
    }),
  ...
  var Gt = kt.extend({
      ...
      _resolveElementOptions: function (t, e) {
        ...
        for (i = 0, n = c.length; i < n; ++i) d[a = c[i]] = Ut([s[a], o[a], l[a]], h, e);
        return d.radius = Ut([s.radius, u ? u.r : void 0, o.radius, l.radius], h, e), d;
      }
    }),
      ...
      labels: {
        generateLabels: function (t) {
          ...
          return e.labels.length && e.datasets.length ? e.labels.map(function (i, n) {
            ...
            return {
              text: i,
              fillStyle: qt([s.backgroundColor, r.backgroundColor, l.backgroundColor], void 0, n),
              strokeStyle: qt([s.borderColor, r.borderColor, l.borderColor], void 0, n),
              lineWidth: qt([s.borderWidth, r.borderWidth, l.borderWidth], void 0, n),
  ...
  var $t = kt.extend({
    ...
    updateElement: function (t, e, i) {
      var n = this,
        ...
        h = o.rotation,
        c = n.getDataset(),
        f = i && s.animateRotate || t.hidden ? 0 : n.calculateCircumference(c.data[e]) * (o.circumference / (2 * Math.PI)),
    ...
    _resolveElementOptions: function (t, e) {
      ...
      for (i = 0, n = h.length; i < n; ++i) u[a = h[i]] = qt([s[a], o[a], l[a]], d, e);
      return u;
    },
  ...
  var Xt = Bt.extend({
    ...
    Kt = ut.valueOrDefault,
    Jt = ut.options.resolve,
    Qt = ut.canvas._isPointInArea;
  function te(t, e) {
  ...
  var ee = kt.extend({
      ...
      updateElement: function (t, e, i) {
        ...
        n = c.getPixelForValue("object" == typeof d ? d : NaN, e, u), a = i ? h.getBasePixel() : r.calculatePointY(d, e, u), t._xScale = c, t._yScale = h, t._options = g, t._datasetIndex = u, t._index = e, t._model = {
          ...
          tension: Kt(s.tension, f ? f.tension : 0),
      ...
      _resolvePointOptions: function (t, e) {
        var i,
          ...
          c = Object.keys(h);
        for (i = 0, n = c.length; i < n; ++i) u[a = c[i]] = Jt([s[a], o[h[a]], o[a], l[a]], d, e);
        return u;
      },
      _resolveLineOptions: function (t) {
        ...
        for (e = 0, i = d.length; e < i; ++e) u[n = d[e]] = Jt([o[n], r[n], l[n]]);
        return u.spanGaps = Kt(r.spanGaps, s.spanGaps), u.tension = Kt(r.lineTension, l.tension), u.steppedLine = Jt([o.steppedLine, r.steppedLine, l.stepped]), u;
      },
      ...
      updateBezierControlPoints: function () {
        ...
        if (a.options.elements.line.capBezierPoints) for (t = 0, e = l.length; t < e; ++t) i = l[t]._model, Qt(i, s) && (t > 0 && Qt(l[t - 1]._model, s) && (i.controlPointPreviousX = u(i.controlPointPreviousX, s.left, s.right), i.controlPointPreviousY = u(i.controlPointPreviousY, s.top, s.bottom)), t < l.length - 1 && Qt(l[t + 1]._model, s) && (i.controlPointNextX = u(i.controlPointNextX, s.left, s.right), i.controlPointNextY = u(i.controlPointNextY, s.top, s.bottom)));
      },
      draw: function () {
        var t,
          e = this.chart,
          ...
          r = n.length,
          o = 0;
        for (te(this.getDataset(), e.options) && (t = (i.dataset._model.borderWidth || 0) / 2, ut.canvas.clipArea(e.ctx, {
          left: a.left,
          right: a.right,
          top: a.top - t,
          bottom: a.bottom + t
      ...
      labels: {
        generateLabels: function (t) {
          ...
          return e.labels.length && e.datasets.length ? e.labels.map(function (i, n) {
            ...
            return {
              text: i,
              fillStyle: ie([o.backgroundColor, r.backgroundColor, s.backgroundColor], void 0, n),
              strokeStyle: ie([o.borderColor, r.borderColor, s.borderColor], void 0, n),
              lineWidth: ie([o.borderWidth, r.borderWidth, s.borderWidth], void 0, n),
              hidden: isNaN(r.data[n]) || a.data[n].hidden,
              index: n
            };
          }) : [];
  ...
  var ne = kt.extend({
    ...
    _resolveElementOptions: function (t, e) {
      var i,
        ...
        h = ["backgroundColor", "borderColor", "borderWidth", "borderAlign", "hoverBackgroundColor", "hoverBorderColor", "hoverBorderWidth"];
      for (i = 0, n = h.length; i < n; ++i) u[a = h[i]] = ie([s[a], o[a], l[a]], d, e);
      return u;
    },
    _computeAngle: function (t) {
      ...
      return ie([e.chart.options.elements.arc.angle, 2 * Math.PI / i], r, t);
    }
  });
  ...
  var se = kt.extend({
    ...
    updateElement: function (t, e, i) {
      ...
      t._scale = o, t._options = l, t._datasetIndex = n.index, t._index = e, t._model = {
        ...
        borderColor: l.borderColor,
        borderWidth: l.borderWidth,
        tension: re(a.tension, u ? u.tension : 0),
        hitRadius: l.hitRadius
      };
    },
    _resolvePointOptions: function (t, e) {
      var i,
        ...
        c = Object.keys(h);
      for (i = 0, n = c.length; i < n; ++i) u[a = c[i]] = oe([s[a], o[h[a]], o[a], l[a]], d, e);
      return u;
    },
    _resolveLineOptions: function (t) {
      var e,
      ...
      for (e = 0, i = u.length; e < i; ++e) l[n = u[e]] = oe([o[n], r[n], s[n]]);
    ...
    update: function (t, e, i) {
      if (t) {
        var n = t.options.layout || {},
          ...
          h = pe(t.boxes, "top"),
          c = pe(t.boxes, "bottom"),
          f = pe(t.boxes, "chartArea");
        ve(u, !0), ve(d, !1), ve(h, !0), ve(c, !1);
        var g,
          m = u.concat(d),
          p = h.concat(c),
          v = m.concat(p),
        ...
        }(v), ut.each(m, I), ye(m, w), ut.each(p, I), ye(p, w), ut.each(m, function (t) {
  ...
  var _e,
    ...
    De = ["animationstart", "webkitAnimationStart"],
    Ce = {
  ...
  var Re = {
    ...
    _ensureLoaded: function () {
      var t, e;
      this._loaded || (this._loaded = !0, this.disableCSSInjection || (t = ke, e = this._style || document.createElement("style"), this._style || (this._style = e, t = "/* Chart.js */\n" + t, e.setAttribute("type", "text/css"), document.getElementsByTagName("head")[0].appendChild(e)), e.appendChild(document.createTextNode(t))));
    },
    ...
    addEventListener: function (t, e, i) {
      ...
      if ("resize" !== e) {
        var a = i[we] || (i[we] = {});
        Oe(n, e, (a.proxies || (a.proxies = {}))[t.id + "_" + e] = function (e) {
          i(function (t, e) {
            var i = Ce[t.type] || t.type,
              n = ut.getRelativePosition(t, e);
            return Ae(i, e, n.x, n.y, t);
          }(e, t));
        });
      } else !function (t, e, i) {
        var n,
          ...
          l = s.resizer = function (t) {
            ...
            return Oe(i, "scroll", a.bind(i, "expand")), Oe(n, "scroll", a.bind(n, "shrink")), e;
          }((n = function () {
            if (s.resizer) {
              var n = i.options.maintainAspectRatio && t.parentNode,
                a = n ? n.clientWidth : 0;
              e(Ae("resize", i)), n && n.clientWidth < a && i.canvas && e(Ae("resize", i));
            }
          }, r = !1, o = [], function () {
  ...
  ut.addEvent = Oe, ut.removeEvent = Ie;
  var Le = Re._enabled ? Re : {
  ...
  var Ge = gt.extend({
      ...
      getTitle: function () {
        var t = this._options.callbacks,
          ...
          a = [];
        return a = He(a, Ee(e)), a = He(a, Ee(i)), He(a, Ee(n));
      },
      ...
      getBody: function (t, e) {
        ...
        return ut.each(t, function (t) {
          ...
          He(r.before, Ee(n.beforeLabel.call(i, t, e))), He(r.lines, n.label.call(i, t, e)), He(r.after, Ee(n.afterLabel.call(i, t, e))), a.push(r);
        }), a;
      },
      ...
      update: function (t) {
        ...
        if (m.length) {
          ...
          var _ = [],
            k = [];
          x = Ve[c.position].call(h, m, h._eventPosition);
          var w = [];
          for (e = 0, i = m.length; e < i; ++e) w.push((a = void 0, r = void 0, void 0, void 0, l = void 0, u = void 0, d = void 0, a = (n = m[e])._xScale, r = n._yScale || n._scale, o = n._index, s = n._datasetIndex, u = (l = n._chart.getDatasetMeta(s).controller)._getIndexScale(), d = l._getValueScale(), {
      ...
      drawBody: function (t, e, i) {
        var n,
          ...
          d = 0,
          h = l ? je(e, "left") : 0;
        i.textAlign = o, i.textBaseline = "top", i.font = ut.fontString(a, e._bodyFontStyle, e._bodyFontFamily), t.x = je(e, o);
        var c = function (e) {
      ...
      drawFooter: function (t, e, i) {
        var n = e.footer;
        n.length && (t.x = je(e, e._footerAlign), t.y += e.footerMarginTop, i.textAlign = e._footerAlign, i.textBaseline = "top", i.fillStyle = e.footerFontColor, i.font = ut.fontString(e.footerFontSize, e._footerFontStyle, e._footerFontFamily), ut.each(n, function (n) {
      ...
      merger: function (t, e, i, n) {
        if ("xAxes" === t || "yAxes" === t) {
          var a,
            ...
            o,
            s = i[t].length;
          for (e[t] || (e[t] = []), a = 0; a < s; ++a) o = i[t][a], r = $e(o.type, "xAxes" === t ? "category" : "linear"), a >= e[t].length && e[t].push({}), !e[t][a].type || o.type && o.type !== e[t][a].type ? ut.merge(e[t][a], [Ne.getScaleDefaults(r), o]) : ut.merge(e[t][a], o);
  ...
  function Ke() {
    return ut.merge({}, [].slice.call(arguments), {
      merger: function (t, e, i, n) {
        var a = e[t] || {},
          r = i[t];
        "scales" === t ? e[t] = Xe(a, r) : "scale" === t ? e[t] = ut.merge(a, [Ne.getScaleDefaults(r.type), r]) : ut._merger(t, e, i, n);
      }
    });
  }
  function Je(t) {
  ...
  ut.extend(Qe.prototype, {
    construct: function (t, e) {
      var i = this;
      e = function (t) {
        var e = (t = t || {}).data = t.data || {};
        return e.datasets = e.datasets || [], e.labels = e.labels || [], t.options = Ke(ot.global, ot[t.type], t.options || {}), t;
      }(e);
      var n = We.acquireContext(t, e),
        a = n && n.canvas,
        r = a && a.height,
        o = a && a.width;
      i.id = ut.uid(), i.ctx = n, i.canvas = a, i.config = e, i.width = o, i.height = r, i.aspectRatio = r ? o / r : null, i.options = e.options, i._bufferedRender = !1, i.chart = i, i.controller = i, Qe.instances[i.id] = i, Object.defineProperty(i, "data", {
        get: function () {
    ...
    initialize: function () {
      var t = this;
      return Ye.notify(t, "beforeInit"), ut.retinaScale(t, t.options.devicePixelRatio), t.bindEvents(), t.options.responsive && t.resize(!0), t.ensureScalesHaveIDs(), t.buildOrUpdateScales(), t.initToolTip(), Ye.notify(t, "afterInit"), t;
    },
    clear: function () {
    ...
    resize: function (t) {
      ...
      if ((e.width !== r || e.height !== o) && (n.width = e.width = r, n.height = e.height = o, n.style.width = r + "px", n.style.height = o + "px", ut.retinaScale(e, i.devicePixelRatio), !t)) {
        ...
        Ye.notify(e, "resize", [s]), i.onResize && i.onResize(e, s), e.stop(), e.update({
    ...
    buildOrUpdateScales: function () {
      ...
      e.scales && (n = n.concat((e.scales.xAxes || []).map(function (t) {
        ...
        var n = e.options,
          r = n.id,
          o = $e(n.type, e.dtype);
        Je(n.position) !== Je(e.dposition) && (n.position = e.dposition), a[r] = !0;
        var s = null;
        ...
        t || delete i[e];
      }), t.scales = i, Ne.addScalesToLayout(this);
    },
    ...
    update: function (t) {
      ...
      if (t && "object" == typeof t || (t = {
        ...
        be.removeBox(e, t);
      }), i = Ke(ot.global, ot[e.config.type], i), e.options = e.config.options = i, e.ensureScalesHaveIDs(), e.buildOrUpdateScales(), e.tooltip._options = i.tooltips, e.tooltip.initialize(), Ye._invalidate(n), !1 !== Ye.notify(n, "beforeUpdate")) {
        ...
        ut.each(n.data.datasets, function (t, e) {
          ...
          t.reset();
        }), n.updateDatasets(), n.tooltip.initialize(), n.lastActive = [], Ye.notify(n, "afterUpdate"), n._bufferedRender ? n._bufferedRequest = {
          duration: t.duration,
          easing: t.easing,
          lazy: t.lazy
        } : n.render(t);
    ...
    updateLayout: function () {
      !1 !== Ye.notify(this, "beforeLayout") && (be.update(this, this.width, this.height), Ye.notify(this, "afterScaleUpdate"), Ye.notify(this, "afterLayout"));
    },
    updateDatasets: function () {
      if (!1 !== Ye.notify(this, "beforeDatasetsUpdate")) {
        for (var t = 0, e = this.data.datasets.length; t < e; ++t) this.updateDataset(t);
        Ye.notify(this, "afterDatasetsUpdate");
      }
    },
    updateDataset: function (t) {
      ...
      !1 !== Ye.notify(this, "beforeDatasetUpdate", [i]) && (e.controller.update(), Ye.notify(this, "afterDatasetUpdate", [i]));
    },
    render: function (t) {
      var e = this;
      t && "object" == typeof t || (t = {
      ...
      var i = e.options.animation,
        n = $e(t.duration, i && i.duration),
        a = t.lazy;
      if (!1 !== Ye.notify(e, "beforeRender")) {
        var r = function (t) {
          Ye.notify(e, "afterRender"), ut.callback(i && i.onComplete, [t], e);
        };
        if (i && n) {
          var o = new pt({
            numSteps: n / 16.66,
    ...
    draw: function (t) {
      var e = this;
      e.clear(), ut.isNullOrUndef(t) && (t = 1), e.transition(t), e.width <= 0 || e.height <= 0 || !1 !== Ye.notify(e, "beforeDraw", [t]) && (ut.each(e.boxes, function (t) {
        t.draw(e.chartArea);
      }, e), e.drawDatasets(t), e._drawTooltip(t), Ye.notify(e, "afterDraw", [t]));
    },
    transition: function (t) {
    ...
    drawDataset: function (t, e) {
      ...
      !1 !== Ye.notify(this, "beforeDatasetDraw", [n]) && (i.controller.draw(e), Ye.notify(this, "afterDatasetDraw", [n]));
    },
    _drawTooltip: function (t) {
      ...
      !1 !== Ye.notify(this, "beforeTooltipDraw", [i]) && (e.draw(), Ye.notify(this, "afterTooltipDraw", [i]));
    },
    ...
    destroy: function () {
      ...
      n && (i.unbindEvents(), ut.canvas.clear(i), We.releaseContext(i.ctx), i.canvas = null, i.ctx = null), Ye.notify(i, "destroy"), delete Qe.instances[i.id];
    },
    ...
    bindEvents: function () {
      ...
      ut.each(t.options.events, function (n) {
        We.addEventListener(t, n, i), e[n] = i;
      }), t.options.responsive && (i = function () {
        t.resize();
      }, We.addEventListener(t, "resize", i), e.resize = i);
    },
    unbindEvents: function () {
      var t = this,
        e = t._listeners;
      e && (delete t._listeners, ut.each(e, function (e, i) {
        We.removeEventListener(t, i, e);
      }));
    },
    ...
    eventHandler: function (t) {
      var e = this,
        i = e.tooltip;
      if (!1 !== Ye.notify(e, "beforeEvent", [t])) {
        e._bufferedRender = !0, e._bufferedRequest = null;
        var n = e.handleEvent(t);
        i && (n = i._start ? i.handleEvent(t) : n | i.handleEvent(t)), Ye.notify(e, "afterEvent", [t]);
  ...
  Qe.Controller = Qe, Qe.types = {}, ut.configMerge = Ke, ut.scaleMerge = Xe, ut.extend(ii.prototype, {
    formats: ei,
    parse: ei,
    format: ei,
    add: ei,
      ...
      fit: function () {
        ...
        if (a.display && s) {
          ...
          if (t._maxLabelLines = v, t.longestLabelWidth = p, u) {
            ...
            var w,
              M,
              S = li(t.ctx, i[0], h.string),
              D = li(t.ctx, i[i.length - 1], h.string),
      ...
      draw: function (t) {
        ...
        if (e._isVisible()) {
          var n,
            ...
            I = [],
            A = h.drawBorder ? oi(h.lineWidth, 0, 0) : 0,
            F = ut._alignPixel;
          if ("top" === f ? (n = F(o, e.bottom, A), a = e.bottom - D, r = n - A / 2) : "bottom" === f ? (n = F(o, e.top, A), a = n + A / 2, r = e.top + D) : "left" === f ? (n = F(o, e.right, A), a = e.right - D, r = n - A / 2) : (n = F(o, e.left, A), a = n + A / 2, r = e.left + D), ut.each(y, function (n, s) {
            if (!ut.isNullOrUndef(n.label)) {
              var l,
                ...
                W,
                Y = n.label;
              s === e.zeroLineIndex && i.offset === h.offsetGridLines ? (l = h.zeroLineWidth, u = h.zeroLineColor, d = h.zeroLineBorderDash || [], c = h.zeroLineBorderDashOffset || 0) : (l = oi(h.lineWidth, s), u = oi(h.color, s), d = h.borderDash || [], c = h.borderDashOffset || 0);
          ...
          if (A) {
            var z,
              ...
              E,
              B = A,
              j = oi(h.lineWidth, y.length - 1, 0);
            p ? (z = F(o, e.left, B) - B / 2, V = F(o, e.right, j) + j / 2, H = E = n) : (H = F(o, e.top, B) - B / 2, E = F(o, e.bottom, j) + j / 2, z = V = n), s.lineWidth = A, s.strokeStyle = oi(h.color, 0), s.beginPath(), s.moveTo(z, H), s.lineTo(V, E), s.stroke();
          }
        }
      }
    }),
  ...
  var xi = ui.extend({
      ...
      handleTickRangeOptions: function () {
        var t = this,
          e = t.options.ticks;
        t.min = bi(e.min, t.min), t.max = bi(e.max, t.max), t.min === t.max && (0 !== t.min && null !== t.min ? (t.min = Math.pow(10, Math.floor(ut.log10(t.min)) - 1), t.max = Math.pow(10, Math.floor(ut.log10(t.max)) + 1)) : (t.min = 1, t.max = 10)), null === t.min && (t.min = Math.pow(10, Math.floor(ut.log10(t.max)) - 1)), null === t.max && (t.max = 0 !== t.min ? Math.pow(10, Math.floor(ut.log10(t.min)) + 1) : 10), null === t.minNotZero && (t.min > 0 ? t.minNotZero = t.min : t.max < 1 ? t.minNotZero = Math.pow(10, Math.floor(ut.log10(t.max))) : t.minNotZero = 1);
      },
      buildTicks: function () {
        var t = this,
          e = t.options.ticks,
          ...
          a = t.ticks = function (t, e) {
            var i,
              n,
              a = [],
              r = vi(t.min, Math.pow(10, Math.floor(ut.log10(e.min)))),
      ...
      getPixelForValue: function (t) {
        var e,
          ...
          h = 0;
        return t = +o.getRightValue(t), l ? (n = o.end, a = o.start, r = -1) : (n = o.start, a = o.end, r = 1), o.isHorizontal() ? (e = o.width, i = l ? o.right : o.left) : (e = o.height, r *= -1, i = l ? o.top : o.bottom), t !== n && (0 === n && (e -= h = vi(s.fontSize, ot.global.defaultFontSize), n = d), 0 !== t && (h += e / (u(a) - u(n)) * (u(t) - u(n))), i += r * h), i;
      },
      getValueForPixel: function (t) {
        var e,
          i,
        ...
        if (s ? (i = r.end, n = r.start) : (i = r.start, n = r.end), r.isHorizontal() ? (e = r.width, a = s ? r.right - t : t - r.left) : (e = r.height, a = s ? t - r.top : r.bottom - t), a !== i) {
          if (0 === i) {
            var d = vi(o.fontSize, ot.global.defaultFontSize);
            a -= d, e -= d, i = u;
          }
  ...
  var ki = ut.valueOrDefault,
    wi = ut.valueAtIndexOrDefault,
    Mi = ut.options.resolve,
    Si = {
      display: !0,
      animate: !0,
      position: "chartArea",
          ...
          (e.angleLines.display || e.pointLabels.display) && function (t) {
            ...
            for (var h = Di(t) - 1; h >= 0; h--) {
              ...
              if (r.display) {
                var f = 0 === h ? l / 2 : 0,
                  ...
                  m = wi(r.fontColor, h, ot.global.defaultFontColor);
                e.fillStyle = m;
                var p = t.getIndexAngle(h),
                  v = ut.toDegrees(p);
                e.textAlign = Ti(v), Ii(v, t._pointLabelSizes[h], g), Oi(e, t.pointLabels[h] || "", g, d.lineHeight);
              }
            }
            e.restore();
            ...
            if (s > 0 || n.reverse) {
              ...
              if (i.display && 0 !== s && function (t, e, i, n) {
                ...
                var u = ki(n.fontColor, ot.global.defaultFontColor);
  ...
  var Li = ut.valueOrDefault,
    Wi = Number.MIN_SAFE_INTEGER || -9007199254740991,
  ...
  function ji(t, e) {
    ...
    var i = t.options.time,
      n = Bi(t, t.getRightValue(e));
    return null === n || i.round && (n = +t._adapter.startOf(n, i.round)), n;
  }
  function Ui(t) {
    for (var e = zi.indexOf(t) + 1, i = zi.length; e < i; ++e) if (Ni[zi[e]].common) return zi[e];
  }
  var Gi = ui.extend({
    initialize: function () {
    ...
    determineDataLimits: function () {
      var t,
        ...
        m = [],
        p = s.data.labels || [];
      for (t = 0, i = p.length; t < i; ++t) m.push(ji(o, p[t]));
      for (t = 0, i = (s.data.datasets || []).length; t < i; ++t) if (s.isDatasetVisible(t)) {
        if (a = s.data.datasets[t].data, ut.isObject(a[0])) for (g[t] = [], e = 0, n = a.length; e < n; ++e) r = ji(o, a[e]), f.push(r), g[t][e] = r;else {
          for (e = 0, n = m.length; e < n; ++e) f.push(m[e]);
          g[t] = m.slice(0);
        }
      } else g[t] = [];
      m.length && (m = Hi(m).sort(Vi), h = Math.min(h, m[0]), c = Math.max(c, m[m.length - 1])), f.length && (f = Hi(f).sort(Vi), h = Math.min(h, f[0]), c = Math.max(c, f[f.length - 1])), h = ji(o, u.min) || h, c = ji(o, u.max) || c, h = h === Yi ? +l.startOf(Date.now(), d) : h, c = c === Wi ? +l.endOf(Date.now(), d) + 1 : c, o.min = Math.min(h, c), o.max = Math.max(h + 1, c), o._horizontal = o.isHorizontal(), o._table = [], o._timestamps = {
        data: f,
        datasets: g,
        labels: m
      };
      ...
      switch (o.ticks.source) {
        ...
        default:
          l = function (t, e, i, n) {
            var a,
              ...
              l = s.unit || function (t, e, i, n) {
                var a,
                  ...
                  o,
                  s = zi.length;
                for (a = zi.indexOf(t); a < s - 1; ++a) if (o = (r = Ni[zi[a]]).steps ? r.steps[r.steps.length - 1] : Yi, r.common && Math.ceil((i - e) / (o * r.size)) <= n) return zi[a];
                return zi[s - 1];
              }(s.minUnit, e, i, n),
              u = Ui(l),
              d = Li(s.stepSize, s.unitStepSize),
            ...
            return p.push(+a), p;
          }(n, a, r, n.getLabelCapacity(a));
      }
      for ("ticks" === o.bounds && l.length && (a = l[0], r = l[l.length - 1]), a = ji(n, s.min) || a, r = ji(n, s.max) || r, t = 0, e = l.length; t < e; ++t) (i = l[t]) >= a && i <= r && u.push(i);
      return n.min = a, n.max = r, n._unit = s.unit || function (t, e, i, n, a) {
        var r, o;
        for (r = zi.length - 1; r >= zi.indexOf(i); r--) if (o = zi[r], Ni[o].common && t._adapter.diff(a, n, o) >= e.length) return o;
        return zi[i ? zi.indexOf(i) : 0];
      }(n, u, s.minUnit, n.min, n.max), n._majorUnit = Ui(n._unit), n._table = function (t, e, i, n) {
        ...
        var r,
          ...
          s = 0,
          l = 0;
        return a.offset && e.length && (a.time.min || (r = Ei(t, "time", e[0], "pos"), s = 1 === e.length ? 1 - r : (Ei(t, "time", e[1], "pos") - r) / 2), a.time.max || (o = Ei(t, "time", e[e.length - 1], "pos"), l = 1 === e.length ? o : (o - Ei(t, "time", e[e.length - 2], "pos")) / 2)), {
          start: s,
          end: l
        };
    ...
    getLabelForIndex: function (t, e) {
      ...
      return ut.isObject(s) && (o = i.getRightValue(s)), r.tooltipFormat ? n.format(Bi(i, o), r.tooltipFormat) : "string" == typeof o ? o : n.format(Bi(i, o), r.displayFormats.datetime);
    },
    tickFormatFunction: function (t, e, i, n) {
      var a = this._adapter,
        ...
        g = c ? h : r.ticks.minor,
        m = Li(g.callback, g.userCallback);
      return m ? m(f, e, i) : f;
    },
    ...
    getLabelWidth: function (t) {
      var e = this.options.ticks,
        ...
        a = Math.cos(n),
        r = Math.sin(n);
      return i * a + Li(e.fontSize, ot.global.defaultFontSize) * r;
    },
  ...
  var qi,
    ...
    $i = (function (t, e) {
      t.exports = function () {
        ...
        function v(t, e) {
          var i, n, a;
          if (o(e._isAMomentObject) || (t._isAMomentObject = e._isAMomentObject), o(e._i) || (t._i = e._i), o(e._f) || (t._f = e._f), o(e._l) || (t._l = e._l), o(e._strict) || (t._strict = e._strict), o(e._tzm) || (t._tzm = e._tzm), o(e._isUTC) || (t._isUTC = e._isUTC), o(e._offset) || (t._offset = e._offset), o(e._pf) || (t._pf = f(e)), o(e._locale) || (t._locale = e._locale), p.length > 0) for (i = 0; i < p.length; i++) o(a = e[n = p[i]]) || (t[n] = a);
          return t;
        }
        var y = !1;
        function b(t) {
        ...
        }), B(0, ["YYYY", 4], 0, "year"), B(0, ["YYYYY", 5], 0, "year"), B(0, ["YYYYYY", 6, !0], 0, "year"), F("year", "y"), Y("year", 1), ut("Y", at), ut("YY", K, q), ut("YYYY", et, $), ut("YYYYY", it, X), ut("YYYYYY", it, X), ft(["YYYYY", "YYYYYY"], 0), ft("YYYY", function (t, e) {
        ...
        function kt(t, e, i) {
          t.isValid() && !isNaN(i) && ("FullYear" === e && vt(t.year()) && 1 === t.month() && 29 === t.date() ? t._d["set" + (t._isUTC ? "UTC" : "") + e](i, t.month(), wt(i, t.month())) : t._d["set" + (t._isUTC ? "UTC" : "") + e](i));
        }
        function wt(t, e) {
        ...
        yt = Array.prototype.indexOf ? Array.prototype.indexOf : function (t) {
          ...
          null != a ? e[1] = a : f(i).invalidMonth = t;
        });
        var Mt = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
        ...
        function Pt(t) {
          return null != t ? (Ct(this, t), n.updateOffset(this, !0), this) : _t(this, "Month");
        }
        var Tt = st,
          Ot = st;
        function It() {
        ...
        function Rt(t, e, i, n, a) {
          ...
          return s <= 0 ? o = pt(r = t - 1) + s : s > pt(t) ? (r = t + 1, o = s - pt(t)) : (r = t, o = s), {
            year: r,
            dayOfYear: o
          };
        }
        function Lt(t, e, i) {
          ...
          return o < 1 ? n = o + Wt(a = t.year() - 1, e, i) : o > Wt(t.year(), e, i) ? (n = o - Wt(t.year(), e, i), a = t.year() + 1) : (a = t.year(), n = o), {
            week: n,
            year: a
          };
        }
        ...
        B("H", ["HH", 2], 0, "hour"), B("h", ["hh", 2], 0, Ut), B("k", ["kk", 2], 0, function () {
          ...
          return "" + Ut.apply(this) + N(this.minutes(), 2);
        }), B("hmmss", 0, 0, function () {
          return "" + Ut.apply(this) + N(this.minutes(), 2) + N(this.seconds(), 2);
        }), B("Hmm", 0, 0, function () {
          return "" + this.hours() + N(this.minutes(), 2);
        }), B("Hmmss", 0, 0, function () {
          return "" + this.hours() + N(this.minutes(), 2) + N(this.seconds(), 2);
        }), Gt("a", !0), Gt("A", !1), F("hour", "h"), Y("hour", 13), ut("a", qt), ut("A", qt), ut("H", K), ut("h", K), ut("k", K), ut("HH", K, q), ut("hh", K, q), ut("kk", K, q), ut("hmm", J), ut("hmmss", Q), ut("Hmm", J), ut("Hmmss", Q), ft(["H", "HH"], 3), ft(["k", "kk"], function (t, e, i) {
          var n = k(t);
          e[3] = 24 === n ? 0 : n;
        }), ft(["a", "A"], function (t, e, i) {
          i._isPm = i._locale.isPM(t), i._meridiem = t;
        }), ft(["h", "hh"], function (t, e, i) {
          e[3] = k(t), f(i).bigHour = !0;
        }), ft("hmm", function (t, e, i) {
          var n = t.length - 2;
          e[3] = k(t.substr(0, n)), e[4] = k(t.substr(n)), f(i).bigHour = !0;
        }), ft("hmmss", function (t, e, i) {
          var n = t.length - 4,
            a = t.length - 2;
          e[3] = k(t.substr(0, n)), e[4] = k(t.substr(n, 2)), e[5] = k(t.substr(a)), f(i).bigHour = !0;
        }), ft("Hmm", function (t, e, i) {
          var n = t.length - 2;
          ...
          var n = t.length - 4,
            a = t.length - 2;
          e[3] = k(t.substr(0, n)), e[4] = k(t.substr(n, 2)), e[5] = k(t.substr(a));
        });
        var Zt,
          $t = xt("Hours", !0),
          Xt = {
        ...
        function te(e) {
          var i = null;
          if (!Kt[e] && t && t.exports) try {
            i = Zt._abbr, xe("./locale/" + e), ee(i);
          } catch (t) {}
          return Kt[e];
        }
        function ee(t, e) {
          var i;
          return t && ((i = o(e) ? ne(t) : ie(t, e)) ? Zt = i : "undefined" != typeof console && console.warn && console.warn("Locale " + t + " not found. Did you forget to load it?")), Zt._abbr;
        }
        function ie(t, e) {
          if (null !== e) {
            var i,
              n = Xt;
            if (e.abbr = t, null != Kt[t]) P("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."), n = Kt[t]._config;else if (null != e.parentLocale) if (null != Kt[e.parentLocale]) n = Kt[e.parentLocale]._config;else {
              if (null == (i = te(e.parentLocale))) return Jt[e.parentLocale] || (Jt[e.parentLocale] = []), Jt[e.parentLocale].push({
                name: t,
                config: e
              }), null;
              n = i._config;
            }
            return Kt[t] = new I(O(n, e)), Jt[t] && Jt[t].forEach(function (t) {
              ie(t.name, t.config);
            }), ee(t), Kt[t];
          }
        ...
        function ne(t) {
          ...
          return function (t) {
            for (var e, i, n, a, r = 0; r < t.length;) {
              for (e = (a = Qt(t[r]).split("-")).length, i = (i = Qt(t[r + 1])) ? i.split("-") : null; e > 0;) {
                if (n = te(a.slice(0, e).join("-"))) return n;
        ...
        function ae(t) {
          var e,
            i = t._a;
          return i && -2 === f(t).overflow && (e = i[1] < 0 || i[1] > 11 ? 1 : i[2] < 1 || i[2] > wt(i[0], i[1]) ? 2 : i[3] < 0 || i[3] > 24 || 24 === i[3] && (0 !== i[4] || 0 !== i[5] || 0 !== i[6]) ? 3 : i[4] < 0 || i[4] > 59 ? 4 : i[5] < 0 || i[5] > 59 ? 5 : i[6] < 0 || i[6] > 999 ? 6 : -1, f(t)._overflowDayOfYear && (e < 0 || e > 2) && (e = 2), f(t)._overflowWeeks && -1 === e && (e = 7), f(t)._overflowWeekday && -1 === e && (e = 8), f(t).overflow = e), t;
        }
        function re(t, e, i) {
        ...
        function oe(t) {
          ...
          if (!t._d) {
            for (a = function (t) {
              ...
              var e, i, n, a, r, o, s, l;
              if (null != (e = t._w).GG || null != e.W || null != e.E) r = 1, o = 4, i = re(e.GG, t._a[0], Lt(ke(), 1, 4).year), n = re(e.W, 1), ((a = re(e.E, 1)) < 1 || a > 7) && (l = !0);else {
                r = t._locale._week.dow, o = t._locale._week.doy;
                var u = Lt(ke(), r, o);
                i = re(e.gg, t._a[0], u.year), n = re(e.w, u.week), null != e.d ? ((a = e.d) < 0 || a > 6) && (l = !0) : null != e.e ? (a = e.e + r, (e.e < 0 || e.e > 6) && (l = !0)) : a = r;
              }
              n < 1 || n > Wt(i, r, o) ? f(t)._overflowWeeks = !0 : null != l ? f(t)._overflowWeekday = !0 : (s = Rt(i, n, a, r, o), t._a[0] = s.year, t._dayOfYear = s.dayOfYear);
            }(t), null != t._dayOfYear && (o = re(t._a[0], a[0]), (t._dayOfYear > pt(o) || 0 === t._dayOfYear) && (f(t)._overflowDayOfYear = !0), i = At(o, 0, t._dayOfYear), t._a[1] = i.getUTCMonth(), t._a[2] = i.getUTCDate()), e = 0; e < 3 && null == t._a[e]; ++e) t._a[e] = s[e] = a[e];
            for (; e < 7; e++) t._a[e] = s[e] = null == t._a[e] ? 2 === e ? 1 : 0 : t._a[e];
            24 === t._a[3] && 0 === t._a[4] && 0 === t._a[5] && 0 === t._a[6] && (t._nextDay = !0, t._a[3] = 0), t._d = (t._useUTC ? At : function (t, e, i, n, a, r, o) {
              var s;
              return t < 100 && t >= 0 ? (s = new Date(t + 400, e, i, n, a, r, o), isFinite(s.getFullYear()) && s.setFullYear(t)) : s = new Date(t, e, i, n, a, r, o), s;
            }).apply(null, s), r = t._useUTC ? t._d.getUTCDay() : t._d.getDay(), null != t._tzm && t._d.setUTCMinutes(t._d.getUTCMinutes() - t._tzm), t._nextDay && (t._a[3] = 24), t._w && void 0 !== t._w.d && t._w.d !== r && (f(t).weekdayMismatch = !0);
          }
        }
        var se = /^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,
          le = /^\s*((?:[+-]\d{6}|\d{4})(?:\d\d\d\d|W\d\d\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?:\d\d(?:\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,
          ue = /Z|[+-]\d\d(?::?\d\d)?/,
          de = [["YYYYYY-MM-DD", /[+-]\d{6}-\d\d-\d\d/], ["YYYY-MM-DD", /\d{4}-\d\d-\d\d/], ["GGGG-[W]WW-E", /\d{4}-W\d\d-\d/], ["GGGG-[W]WW", /\d{4}-W\d\d/, !1], ["YYYY-DDD", /\d{4}-\d{3}/], ["YYYY-MM", /\d{4}-\d\d/, !1], ["YYYYYYMMDD", /[+-]\d{10}/], ["YYYYMMDD", /\d{8}/], ["GGGG[W]WWE", /\d{4}W\d{3}/], ["GGGG[W]WW", /\d{4}W\d{2}/, !1], ["YYYYDDD", /\d{7}/]],
        ...
        function fe(t) {
          var e,
            ...
            o,
            s = t._i,
            l = se.exec(s) || le.exec(s);
          if (l) {
            for (f(t).iso = !0, e = 0, i = de.length; e < i; e++) if (de[e][1].exec(l[1])) {
              a = de[e][0], n = !1 !== de[e][2];
              break;
            }
            if (null == a) return void (t._isValid = !1);
            if (l[3]) {
              for (e = 0, i = he.length; e < i; e++) if (he[e][1].exec(l[3])) {
                r = (l[2] || " ") + he[e][0];
                break;
              }
            ...
            if (l[4]) {
              if (!ue.exec(l[4])) return void (t._isValid = !1);
              o = "Z";
            }
            t._f = a + (r || "") + (o || ""), ye(t);
          } else t._isValid = !1;
        ...
        function ve(t) {
          var e,
            ...
            o,
            s,
            l = ge.exec(t._i.replace(/\([^)]*\)|[\n\t]/g, " ").replace(/(\s\s+)/g, " ").replace(/^\s\s*/, "").replace(/\s\s*$/, ""));
          if (l) {
            var u = (e = l[4], i = l[3], n = l[2], a = l[5], r = l[6], o = l[7], s = [me(e), Dt.indexOf(i), parseInt(n, 10), parseInt(a, 10), parseInt(r, 10)], o && s.push(parseInt(o, 10)), s);
            if (!function (t, e, i) {
              if (t && zt.indexOf(t) !== new Date(e[0], e[1], e[2]).getDay()) return f(i).weekdayMismatch = !0, i._isValid = !1, !1;
              return !0;
            }(l[1], u, t)) return;
            t._a = u, t._tzm = function (t, e, i) {
              ...
              var n = parseInt(i, 10),
                a = n % 100;
              return 60 * ((n - a) / 100) + a;
            }(l[8], l[9], l[10]), t._d = At.apply(null, t._a), t._d.setUTCMinutes(t._d.getUTCMinutes() - t._tzm), f(t).rfc2822 = !0;
          } else t._isValid = !1;
        }
        function ye(t) {
          if (t._f !== n.ISO_8601) {
        ...
        function be(t) {
          ...
          return t._locale = t._locale || ne(t._l), null === e || void 0 === i && "" === e ? m({
            nullInput: !0
          }) : ("string" == typeof e && (t._i = e = t._locale.preparse(e)), x(e) ? new b(ae(e)) : (l(e) ? t._d = e : a(i) ? function (t) {
            var e, i, n, a, r;
            if (0 === t._f.length) return f(t).invalidFormat = !0, void (t._d = new Date(NaN));
            for (a = 0; a < t._f.length; a++) r = 0, e = v({}, t), null != t._useUTC && (e._useUTC = t._useUTC), e._f = t._f[a], ye(e), g(e) && (r += f(e).charsLeftOver, r += 10 * f(e).unusedTokens.length, f(e).score = r, (null == n || r < n) && (n = r, i = e));
            h(t, i || e);
          }(t) : i ? ye(t) : function (t) {
            var e = t._i;
            o(e) ? t._d = new Date(n.now()) : l(e) ? t._d = new Date(e.valueOf()) : "string" == typeof e ? function (t) {
              var e = ce.exec(t._i);
              null === e ? (fe(t), !1 === t._isValid && (delete t._isValid, ve(t), !1 === t._isValid && (delete t._isValid, n.createFromInputFallback(t)))) : t._d = new Date(+e[1]);
        ...
        function _e(t, e, i, n, o) {
          ...
          return !0 !== i && !1 !== i || (n = i, i = void 0), (r(t) && function (t) {
            ...
            return !0;
          }(t) || a(t) && 0 === t.length) && (t = void 0), l._isAMomentObject = !0, l._useUTC = l._isUTC = o, l._l = i, l._i = t, l._f = e, l._strict = n, (s = new b(ae(be(l))))._nextDay && (s.add(1, "d"), s._nextDay = void 0), s;
        }
        function ke(t, e, i, n) {
          return _e(t, e, i, n, !1);
        }
        ...
        var we = S("moment().min is deprecated, use moment.max instead. http://momentjs.com/guides/#/warnings/min-max/", function () {
        ...
        function Ce(t) {
          ...
          this._isValid = function (t) {
            for (var e in t) if (-1 === yt.call(De, e) || null != t[e] && isNaN(t[e])) return !1;
            for (var i = !1, n = 0; n < De.length; ++n) if (t[De[n]]) {
              if (i) return !1;
              parseFloat(t[De[n]]) !== k(t[De[n]]) && (i = !0);
            }
            return !0;
          }(e), this._milliseconds = +d + 1e3 * u + 6e4 * l + 1e3 * s * 60 * 60, this._days = +o + 7 * r, this._months = +a + 3 * n + 12 * i, this._data = {}, this._locale = ne(), this._bubble();
        }
        function Pe(t) {
        ...
        Oe("Z", ":"), Oe("ZZ", ""), ut("Z", ot), ut("ZZ", ot), ft(["Z", "ZZ"], function (t, e, i) {
          i._useUTC = !0, i._tzm = Ae(ot, t);
        });
        var Ie = /([\+\-]|\d\d)/gi;
        function Ae(t, e) {
          var i = (e || "").match(t);
        ...
        function Fe(t, e) {
          var i, a;
          return e._isUTC ? (i = e.clone(), a = (x(t) || l(t) ? t.valueOf() : ke(t).valueOf()) - i.valueOf(), i._d.setTime(i._d.valueOf() + a), n.updateOffset(i, !1), i) : ke(t).local();
        }
        function Re(t) {
        ...
        function Ne(t, e) {
          ...
          return Pe(t) ? u = {
            ...
            d: t._days,
            M: t._months
          } : s(t) ? (u = {}, e ? u[e] = t : u.milliseconds = t) : (h = We.exec(t)) ? (i = "-" === h[1] ? -1 : 1, u = {
            y: 0,
            d: k(h[2]) * i,
            h: k(h[3]) * i,
            m: k(h[4]) * i,
            ...
            m: ze(h[7], i),
            s: ze(h[8], i)
          }) : null == u ? u = {} : "object" == typeof u && ("from" in u || "to" in u) && (r = ke(u.from), o = ke(u.to), a = r.isValid() && o.isValid() ? (o = Fe(o, r), r.isBefore(o) ? l = Ve(r, o) : ((l = Ve(o, r)).milliseconds = -l.milliseconds, l.months = -l.months), l) : {
            milliseconds: 0,
            months: 0
          }, (u = {}).ms = a.milliseconds, u.M = a.months), n = new Ce(u), Pe(t) && d(t, "_locale") && (n._locale = t._locale), n;
        }
        function ze(t, e) {
        ...
        function He(t, e) {
          return function (i, n) {
            var a;
            return null === n || isNaN(+n) || (P(e, "moment()." + e + "(period, number) is deprecated. Please use moment()." + e + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."), a = i, i = n, n = a), Ee(this, Ne(i = "string" == typeof i ? +i : i, n), t), this;
          };
        }
        function Ee(t, e, i, a) {
          var r = e._milliseconds,
            o = Te(e._days),
            s = Te(e._months);
          t.isValid() && (a = null == a || a, s && Ct(t, _t(t, "Month") + s * i), o && kt(t, "Date", _t(t, "Date") + o * i), r && t._d.setTime(t._d.valueOf() + r * i), a && n.updateOffset(t, o || s));
        }
        Ne.fn = Ce.prototype, Ne.invalid = function () {
          return Ne(NaN);
        };
        var Be = He(1, "add"),
          je = He(-1, "subtract");
        function Ue(t, e) {
          ...
          return e - a < 0 ? i = (e - a) / (a - t.clone().add(n - 1, "months")) : i = (e - a) / (t.clone().add(n + 1, "months") - a), -(n + i) || 0;
        }
        function Ge(t) {
          var e;
        ...
        function ti(t, e, i) {
          return t < 100 && t >= 0 ? new Date(t + 400, e, i) - Je : new Date(t, e, i).valueOf();
        }
        function ei(t, e, i) {
          return t < 100 && t >= 0 ? Date.UTC(t + 400, e, i) - Je : Date.UTC(t, e, i);
        }
        function ii(t, e) {
          B(0, [t, t.length], 0, e);
        }
        function ni(t, e, i, n, a) {
          var r;
          return null == t ? Lt(this, n, a).year : (e > (r = Wt(t, n, a)) && (e = r), function (t, e, i, n, a) {
            var r = Rt(t, e, i, n, a),
        ...
        }), ii("gggg", "weekYear"), ii("ggggg", "weekYear"), ii("GGGG", "isoWeekYear"), ii("GGGGG", "isoWeekYear"), F("weekYear", "gg"), F("isoWeekYear", "GG"), Y("weekYear", 1), Y("isoWeekYear", 1), ut("G", at), ut("g", at), ut("GG", K, q), ut("gg", K, q), ut("GGGG", et, $), ut("gggg", et, $), ut("GGGGG", it, X), ut("ggggg", it, X), gt(["gggg", "ggggg", "GGGG", "GGGGG"], function (t, e, i, n) {
          e[n.substr(0, 2)] = k(t);
        ...
        B("DDD", ["DDDD", 3], "DDDo", "dayOfYear"), F("dayOfYear", "DDD"), Y("dayOfYear", 4), ut("DDD", tt), ut("DDDD", Z), ft(["DDD", "DDDD"], function (t, e, i) {
          i._dayOfYear = k(t);
        }), B("m", ["mm", 2], 0, "minute"), F("minute", "m"), Y("minute", 14), ut("m", K), ut("mm", K, q), ft(["m", "mm"], 4);
        var ri = xt("Minutes", !1);
        B("s", ["ss", 2], 0, "second"), F("second", "s"), Y("second", 15), ut("s", K), ut("ss", K, q), ft(["s", "ss"], 5);
        var oi,
          si = xt("Seconds", !1);
        ...
        }), F("millisecond", "ms"), Y("millisecond", 16), ut("S", tt, G), ut("SS", tt, q), ut("SSS", tt, Z), oi = "SSSS"; oi.length <= 9; oi += "S") ut(oi, nt);
        function li(t, e) {
          e[6] = k(1e3 * ("0." + t));
        }
        for (oi = "S"; oi.length <= 9; oi += "S") ft(oi, li);
        var ui = xt("Milliseconds", !1);
        B("z", 0, 0, "zoneAbbr"), B("zz", 0, 0, "zoneName");
        var di = b.prototype;
        function hi(t) {
          return t;
        }
        di.add = Be, di.calendar = function (t, e) {
          var i = t || ke(),
            a = Fe(i, this).startOf("day"),
          ...
          switch (t) {
            ...
            case "date":
              ...
              break;
            case "hour":
              e = this._d.valueOf(), e += Ke - Qe(e + (this._isUTC ? 0 : this.utcOffset() * Xe), Ke) - 1;
              break;
            case "minute":
              e = this._d.valueOf(), e += Xe - Qe(e, Xe) - 1;
              break;
            case "second":
              e = this._d.valueOf(), e += $e - Qe(e, $e) - 1;
          }
          ...
          return this.isValid() && (x(t) && t.isValid() || ke(t).isValid()) ? Ne({
            to: this,
            from: t
          ...
          return g(this);
        }, di.lang = qe, di.locale = Ge, di.localeData = Ze, di.max = Me, di.min = we, di.parsingFlags = function () {
          return h({}, f(this));
        }, di.set = function (t, e) {
          ...
          switch (t) {
            ...
            case "date":
              ...
              break;
            case "hour":
              e = this._d.valueOf(), e -= Qe(e + (this._isUTC ? 0 : this.utcOffset() * Xe), Ke);
              break;
            case "minute":
              e = this._d.valueOf(), e -= Qe(e, Xe);
              break;
            case "second":
              e = this._d.valueOf(), e -= Qe(e, $e);
          }
          return this._d.setTime(e), n.updateOffset(this, !0), this;
        }, di.subtract = je, di.toArray = function () {
          var t = this;
        ...
        }, di.year = bt, di.isLeapYear = function () {
          return vt(this.year());
        ...
        }, di.month = Pt, di.daysInMonth = function () {
          ...
          return null == t ? e : this.add(t - e, "d");
        }, di.hour = di.hours = $t, di.minute = di.minutes = ri, di.second = di.seconds = si, di.millisecond = di.milliseconds = ui, di.utcOffset = function (t, e, i) {
          var a,
            r = this._offset || 0;
          if (!this.isValid()) return null != t ? this : NaN;
          if (null != t) {
            if ("string" == typeof t) {
              if (null === (t = Ae(ot, t))) return this;
            } else Math.abs(t) < 16 && !i && (t *= 60);
            return !this._isUTC && e && (a = Re(this)), this._offset = t, this._isUTC = !0, null != a && this.add(a, "m"), r !== t && (!e || this._changeInProgress ? Ee(this, Ne(t - r, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, n.updateOffset(this, !0), this._changeInProgress = null)), this;
          }
          ...
          return !!this.isValid() && this._isUTC;
        }, di.isUtc = Le, di.isUTC = Le, di.zoneAbbr = function () {
          return this._isUTC ? "UTC" : "";
        }, di.zoneName = function () {
          return this._isUTC ? "Coordinated Universal Time" : "";
        }, di.dates = S("dates accessor is deprecated. Use date instead.", ai), di.months = S("months accessor is deprecated. Use month instead", Pt), di.years = S("years accessor is deprecated. Use year instead", bt), di.zone = S("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", function (t, e) {
          return null != t ? ("string" != typeof t && (t = -t), this.utcOffset(t, e), this) : -this.utcOffset();
        }), di.isDSTShifted = S("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information", function () {
          if (!o(this._isDSTShifted)) return this._isDSTShifted;
          var t = {};
          if (v(t, this), (t = be(t))._a) {
        ...
        function mi(t, e, i, n) {
          ...
          var l = [];
          for (a = 0; a < 7; a++) l[a] = fi(e, (a + o) % 7, n, "day");
          return l;
        }
        ci.calendar = function (t, e, i) {
          ...
          return t ? a(this._months) ? this._months[t.month()] : this._months[(this._months.isFormat || Mt).test(e) ? "format" : "standalone"][t.month()] : a(this._months) ? this._months : this._months.standalone;
        }, ci.monthsShort = function (t, e) {
          return t ? a(this._monthsShort) ? this._monthsShort[t.month()] : this._monthsShort[Mt.test(e) ? "format" : "standalone"][t.month()] : a(this._monthsShort) ? this._monthsShort : this._monthsShort.standalone;
          ...
          if (this._monthsParseExact) return function (t, e, i) {
            ...
            return i ? "MMM" === e ? -1 !== (a = yt.call(this._shortMonthsParse, o)) ? a : null : -1 !== (a = yt.call(this._longMonthsParse, o)) ? a : null : "MMM" === e ? -1 !== (a = yt.call(this._shortMonthsParse, o)) || -1 !== (a = yt.call(this._longMonthsParse, o)) ? a : null : -1 !== (a = yt.call(this._longMonthsParse, o)) || -1 !== (a = yt.call(this._shortMonthsParse, o)) ? a : null;
          }.call(this, t, e, i);
          ...
          return this._monthsParseExact ? (d(this, "_monthsRegex") || It.call(this), t ? this._monthsStrictRegex : this._monthsRegex) : (d(this, "_monthsRegex") || (this._monthsRegex = Ot), this._monthsStrictRegex && t ? this._monthsStrictRegex : this._monthsRegex);
        }, ci.monthsShortRegex = function (t) {
          return this._monthsParseExact ? (d(this, "_monthsRegex") || It.call(this), t ? this._monthsShortStrictRegex : this._monthsShortRegex) : (d(this, "_monthsShortRegex") || (this._monthsShortRegex = Tt), this._monthsShortStrictRegex && t ? this._monthsShortStrictRegex : this._monthsShortRegex);
        }, ci.week = function (t) {
          ...
          return this._weekdaysParseExact ? (d(this, "_weekdaysRegex") || jt.call(this), t ? this._weekdaysStrictRegex : this._weekdaysRegex) : (d(this, "_weekdaysRegex") || (this._weekdaysRegex = Ht), this._weekdaysStrictRegex && t ? this._weekdaysStrictRegex : this._weekdaysRegex);
        }, ci.weekdaysShortRegex = function (t) {
          return this._weekdaysParseExact ? (d(this, "_weekdaysRegex") || jt.call(this), t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex) : (d(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = Et), this._weekdaysShortStrictRegex && t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex);
        }, ci.weekdaysMinRegex = function (t) {
          return this._weekdaysParseExact ? (d(this, "_weekdaysRegex") || jt.call(this), t ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (d(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Bt), this._weekdaysMinStrictRegex && t ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex);
        }, ci.isPM = function (t) {
        ...
        }), n.lang = S("moment.lang is deprecated. Use moment.locale instead.", ee), n.langData = S("moment.langData is deprecated. Use moment.localeData instead.", ne);
        var pi = Math.abs;
        function vi(t, e, i, n) {
          var a = Ne(e, i);
        ...
        function Bi() {
          ...
          if (!h) return "P0D";
          var c = h < 0 ? "-" : "",
            f = Ei(this._months) !== Ei(h) ? "-" : "",
            g = Ei(this._days) !== Ei(h) ? "-" : "",
            m = Ei(this._milliseconds) !== Ei(h) ? "-" : "";
        ...
        return ji.isValid = function () {
          ...
          if ("month" === (t = R(t)) || "quarter" === t || "year" === t) switch (e = this._days + n / 864e5, i = this._months + bi(e), t) {
            case "month":
              return i;
            case "quarter":
              return i / 3;
        ...
        }, ji.asMilliseconds = ki, ji.asSeconds = wi, ji.asMinutes = Mi, ji.asHours = Si, ji.asDays = Di, ji.asWeeks = Ci, ji.asMonths = Pi, ji.asQuarters = Ti, ji.asYears = Oi, ji.valueOf = function () {
          ...
          var t,
            ...
            s = this._months,
            l = this._data;
          return r >= 0 && o >= 0 && s >= 0 || r <= 0 && o <= 0 && s <= 0 || (r += 864e5 * yi(xi(s) + o), o = 0, s = 0), l.milliseconds = r % 1e3, t = _(r / 1e3), l.seconds = t % 60, e = _(t / 60), l.minutes = e % 60, i = _(e / 60), l.hours = i % 24, o += _(i / 24), s += a = _(bi(o)), o -= yi(xi(a)), n = _(s / 12), s %= 12, l.days = o, l.months = s, l.years = n, this;
        }, ji.clone = function () {
          return Ne(this);
        }, ji.get = function (t) {
          return t = R(t), this.isValid() ? this[t + "s"]() : NaN;
        }, ji.milliseconds = Ai, ji.seconds = Fi, ji.minutes = Ri, ji.hours = Li, ji.days = Wi, ji.weeks = function () {
          return _(this.days() / 7);
        }, ji.months = Yi, ji.years = Ni, ji.humanize = function (t) {
          if (!this.isValid()) return this.localeData().invalidDate();
          var e = this.localeData(),
            i = function (t, e, i) {
              var n = Ne(t).abs(),
                ...
                l = zi(n.as("M")),
                u = zi(n.as("y")),
                d = a <= Vi.ss && ["s", a] || a < Vi.s && ["ss", a] || r <= 1 && ["m"] || r < Vi.m && ["mm", r] || o <= 1 && ["h"] || o < Vi.h && ["hh", o] || s <= 1 && ["d"] || s < Vi.d && ["dd", s] || l <= 1 && ["M"] || l < Vi.M && ["MM", l] || u <= 1 && ["y"] || ["yy", u];
              return d[2] = e, d[3] = +t > 0, d[4] = i, function (t, e, i, n, a) {
                return a.relativeTime(e || 1, !!i, t, n);
              }.apply(null, d);
            }(this, !t, e);
          return t && (i = e.pastFuture(+this, i)), e.postformat(i);
        }, ji.toISOString = Bi, ji.toString = Bi, ji.toJSON = Bi, ji.locale = Ge, ji.localeData = Ze, ji.toIsoString = S("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", Bi), ji.lang = qe, B("X", 0, 0, "unix"), B("x", 0, 0, "valueOf"), ut("x", at), ut("X", /[+-]?\d+(\.\d{1,3})?/), ft("X", function (t, e, i) {
          i._d = new Date(1e3 * parseFloat(t, 10));
        }), ft("x", function (t, e, i) {
          i._d = new Date(k(t));
        }), n.version = "2.24.0", e = ke, n.fn = di, n.min = function () {
        ...
        }, n.isDate = l, n.locale = ee, n.invalid = m, n.duration = Ne, n.isMoment = x, n.weekdays = function (t, e, i) {
          return mi(t, e, i, "weekdays");
        }, n.parseZone = function () {
          return ke.apply(null, arguments).parseZone();
        }, n.localeData = ne, n.isDuration = Pe, n.monthsShort = function (t, e) {
          return gi(t, e, "monthsShort");
        }, n.weekdaysMin = function (t, e, i) {
          return mi(t, e, i, "weekdaysMin");
        }, n.defineLocale = ie, n.updateLocale = function (t, e) {
          if (null != e) {
            var i,
              n,
              a = Xt;
            null != (n = te(t)) && (a = n._config), (i = new I(e = O(a, e))).parentLocale = Kt[t], Kt[t] = i, ee(t);
          } else null != Kt[t] && (null != Kt[t].parentLocale ? Kt[t] = Kt[t].parentLocale : null != Kt[t] && delete Kt[t]);
          return Kt[t];
        }, n.locales = function () {
          return D(Kt);
  ...
  ni._date.override("function" == typeof $i ? {
    _id: "moment",
    formats: function () {
      return Xi;
    },
    ...
    add: function (t, e, i) {
      return $i(t).add(e, i).valueOf();
    },
    diff: function (t, e, i) {
      return $i.duration($i(t).diff($i(e))).as(i);
    },
    startOf: function (t, e, i) {
      return t = $i(t), "isoWeek" === e ? t.isoWeekday(i).valueOf() : t.startOf(e).valueOf();
    },
    endOf: function (t, e) {
  ...
  function en(t) {
    var e = t.fill,
      i = "dataset";
    return !1 === e ? null : (isFinite(e) || (i = "boundary"), Ki[i](t));
  }
  function nn(t) {
    return t && !t.skip;
  }
  ...
  var rn = {
      ...
      afterDatasetsUpdate: function (t, e) {
        ...
        for (n = 0; n < o; ++n) (r = l[n]) && (r.fill = tn(l, n, s), r.boundary = Qi(r), r.mapper = en(r));
      },
        ...
        if (i) {
          ...
          s && l && o.length && (ut.canvas.clipArea(n, t.chartArea), function (t, e, i, n, a, r) {
            var o,
              ...
              v = 0,
              y = 0;
            for (t.beginPath(), o = 0, s = f + !!r; o < s; ++o) d = i(u = e[l = o % f]._view, l, n), h = nn(u), c = nn(d), h && c ? (v = m.push(u), y = p.push(d)) : v && y && (g ? (h && m.push(u), c && p.push(d)) : (an(t, m, p, v, y), v = y = 0, m = [], p = []));
            an(t, m, p, v, y), t.closePath(), t.fillStyle = a, t.fill();
          }(n, o, s, r, l, a._loop), ut.canvas.unclipArea(n));
        }
      }
    },
    on = ut.noop,
    sn = ut.valueOrDefault;
  function ln(t, e) {
  ...
  var un = gt.extend({
    ...
    fit: function () {
      ...
      if (u ? (l.width = t.maxWidth, l.height = n ? 10 : 0) : (l.width = n ? 10 : 0, l.height = t.maxHeight), n) if (a.font = r.string, u) {
        ...
        a.textAlign = "left", a.textBaseline = "top", ut.each(t.legendItems, function (t, e) {
          var n = ln(i, o) + o / 2 + a.measureText(t.text).width;
    ...
    draw: function () {
      ...
      if (e.display) {
        var l,
          u = t.ctx,
          d = sn(i.fontColor, n.defaultFontColor),
        ...
        ut.each(t.legendItems, function (n, d) {
          ...
          m ? d > 0 && y + v + i.padding > t.left + t.minSize.width && (b = l.y += p, l.line++, y = l.x = t.left + (o - s[l.line]) / 2 + i.padding) : d > 0 && b + p > t.top + t.minSize.height && (y = l.x = y + t.columnWidths[l.line] + i.padding, b = l.y = t.top + i.padding, l.line++), function (t, i, n) {
            if (!(isNaN(f) || f <= 0)) {
              u.save();
              var o = sn(n.lineWidth, r.borderWidth);
              if (u.fillStyle = sn(n.fillStyle, a), u.lineCap = sn(n.lineCap, r.borderCapStyle), u.lineDashOffset = sn(n.lineDashOffset, r.borderDashOffset), u.lineJoin = sn(n.lineJoin, r.borderJoinStyle), u.lineWidth = o, u.strokeStyle = sn(n.strokeStyle, a), u.setLineDash && u.setLineDash(sn(n.lineDash, r.borderDash)), e.labels && e.labels.usePointStyle) {
  ...
  var hn = {
      ...
      beforeUpdate: function (t) {
        var e = t.options.legend,
          i = t.legend;
        e ? (ut.mergeIf(e, ot.global.legend), i ? (be.configure(t, i, e), i.options = e) : dn(t, e)) : i && (be.removeBox(t, i), delete t.legend);
      },
  ...
  var mn = {},
    ...
    yn = {
      ...
      beforeUpdate: function (t) {
        var e = t.options.title,
          i = t.titleBlock;
        e ? (ut.mergeIf(e, ot.global.title), i ? (be.configure(t, i, e), i.options = e) : gn(t, e)) : i && (be.removeBox(t, i), delete t.titleBlock);
      }
    };
  for (var bn in mn.filler = pn, mn.legend = vn, mn.title = yn, ti.helpers = ut, function () {
    function t(t, e, i) {
      var n;
  ...
  }(), ti._adapters = ni, ti.Animation = pt, ti.animationService = vt, ti.controllers = le, ti.DatasetController = kt, ti.defaults = ot, ti.Element = gt, ti.elements = Yt, ti.Interaction = me, ti.layouts = be, ti.platform = We, ti.plugins = Ye, ti.Scale = ui, ti.scaleService = Ne, ti.Ticks = ai, ti.Tooltip = Ze, ti.helpers.each(Zi, function (t, e) {
    ti.scaleService.registerScaleType(e, t, t._defaults);
  }), mn) mn.hasOwnProperty(bn) && ti.plugins.register(mn[bn]);
  ti.platform.initialize();
  var xn = ti;
  return "undefined" != typeof window && (window.Chart = ti), ti.Chart = ti, ti.Legend = mn.legend._element, ti.Title = mn.title._element, ti.pluginService = ti.plugins, ti.PluginBase = ti.Element.extend({}), ti.canvasHelpers = ti.helpers.canvas, ti.layoutService = ti.layouts, ti.LinearScaleBase = fi, ti.helpers.each(["Bar", "Bubble", "Doughnut", "Line", "PolarArea", "Radar", "Scatter"], function (t) {
    ti[t] = function (e, i) {
      return new ti(e, ti.helpers.merge(i || {}, {
        type: t.charAt(0).toLowerCase() + t.slice(1)
      }));
    };
  }), xn;
});
//# sourceMappingURL=chart.min.min.js.map